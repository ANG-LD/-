...
abstract class OAuth2 {
   ...
   * @ingroup oauth2_section_4
   */
  public function grantAccessToken($user_id) {
    $filters = array(
  ...
  protected function createAccessToken($client_id,$user_id,$scope = NULL) {
    ...
    $this->setAccessToken($token["access_token"], $client_id,$user_id, time() + $this->getVariable('access_token_lifetime', OAUTH2_DEFAULT_ACCESS_TOKEN_LIFETIME), $scope);
