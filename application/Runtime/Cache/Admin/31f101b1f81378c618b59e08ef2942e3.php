...
<div class="ml170" id="page-content" style="overflow:auto;min-height:100%">
	<?php echo W('public/breadcrumbs',[ [ ['href'=>'','text'=>'待支付订单'] ] ]);?>
<div class="page-container">
    <div class="text-l">
        <form class="search" action="/system.php/Horder/to_be_pay.html" method="get">
...
<script type="text/javascript">
    ...
    function xiazai(){
        ...
        var url = "/system.php/Horder/to_be_pay.html";
        if(url.split("?")[1]){
            window.location.href="/system.php/Horder/to_be_pay.html&act="+download;
        }else{
            window.location.href="/system.php/Horder/to_be_pay.html?act="+download;
        }
    }
    function getnums(){
        var num = $("#nus").val();
        window.location.href="/system.php/Horder/to_be_pay.html&num="+num;
    }
