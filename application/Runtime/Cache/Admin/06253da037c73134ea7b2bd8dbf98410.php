...
<div class="speak_person_list_box">
  <div class="speak_person_hd" id="speak_person_hd">
    ...
    <div class="speak_personlist">
      <ul>
        <li onclick="msgUserListClick()"><i class="i_ico"></i><span>020ljystc:11</span></li>
        <li><i class="i_ico no_line"></i><span>020ljystc:22</span></li>
        <li><i class="i_ico no_line"></i><span>020ljystc:33</span></li>
        <li><i class="i_ico"></i><span>020ljystc:44</span></li>
        <li><i class="i_ico"></i><span>020ljystc:55</span></li>
        <li><i class="i_ico"></i><span>020ljystc:66</span></li>
        <li><i class="i_ico"></i><span>020ljystc:77</span></li>
        <li><i class="i_ico"></i><span>020ljystc:88</span></li>
        <li><i class="i_ico"></i><span>020ljystc:99</span></li>
        <li><i class="i_ico"></i><span>020ljystc:10</span></li>
        <li><i class="i_ico"></i><span>020ljystc:11</span></li>
        <li><i class="i_ico"></i><span>020ljystc:1212</span></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tool_speak_box">
  ...
  <div class="tool_s_box_content">
    <div class="tool_s_b_l">
      ...
      <div class="tool_talkfoot"> <span><a href="#">有问题请联系整案客服</a></span> <a href="javascript:void(0);" onclick="newSend($('.textarea').html())" class="tool_talkbar goto_talk" id="goto_talk_btn">发送</a> </div>
    </div>
...
//		msgArr = {};
//	}
//	msgArr['hx_username']["msgData"] = {};
//	console.log(msgArr.hx_username["msgData"]);
...
//				$('#').append('<div class="newsListBox pt20"><div class="newsTime f12 col_b7 mb5">'+ $scope.onNewsTime + '</div><div class="clearfix"><div class="fr chat_userImg">< img src="'+ $scope.userInfo.img +'" alt=""></div><div class="fr newsTxtBox bor back_fff f12">'+ $scope.msgArr[hx_username]["msgData"][i].data +'</div></div></div>');
//			}else{ //收到的消息
...
//					/*根据环信用户名查找用户信息*/
//					$.ajax({
//						url:"<?php echo U('api/index/get_user_info');?>",
//						type: 'POST',
//						data: {hx_username:message.from},// 环信用户名
//						async: false,
//						cache: false,
//						contentType: false,
//						processData: false,
...
//					onDate = new Date();
//					//onNewsTime = $filter('date')($scope.onDate, "yyyy-MM-dd hh:mm:ss");
...
//	});
	...
	sendNewsObj = {};
	 function sendPrivateText(n) { // n消息内容
		...
		var newsTime = currentTime();
		 console.log(newsTime);
		var txtMsg = n;
		var msgU_hx = 'bsxykefu001';
		msg.set({
			msg: txtMsg,     // 消息内容
