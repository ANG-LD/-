...
<div class="ml170" id="page-content" style="overflow:auto;min-height:100%">
	<?php echo W('public/breadcrumbs',[ [ ['href'=>U('Charts/month'),'text'=>'月活跃度'], ] ]);?>
<div class="page-container">
    <div class="text-l">
        <input type="text" class="input-text" name="start_time" value="<?php echo ($month); ?>" id="start_time" placeholder="月份时间"  style="width:250px">
...
<script type="text/javascript">
    $(function () {
    var url = "<?php echo U('Charts/month_code');?>";
    function code(e) {
