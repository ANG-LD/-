...
<div class="ml170" id="page-content" style="overflow:auto;min-height:100%">
	<?php echo W('public/breadcrumbs',[ [ ['href'=>U('Horder/to_all_order'),'text'=>'全部订单'], ] ]);?>
<div class="page-container">
    <div class="text-l">
        <form class="search" action="/system.php/Horder/to_all_order.html" method="get">
            ...
            <input type="text" class="input-text "  id="start_time" style="width:250px" name="start_time" value="<?php echo urldecode($_GET['start_time']) ?>"  placeholder="开始时间" readonly>
            <input type="text" class="input-text "  id="end_time" style="width:250px" name="end_time" value="<?php echo ($_GET['end_time']); ?>"  placeholder="结束时间" readonly>
...
<script type="text/javascript">
    ...
    function xiazai(){
        ...
        var url = "/system.php/Horder/to_all_order.html";
        if(url.split("?")[1]){
            window.location.href="/system.php/Horder/to_all_order.html&act="+download;
        }else{
            window.location.href="/system.php/Horder/to_all_order.html?act="+download;
        }
    }
    function getnums(){
        var num = $("#nus").val();
        window.location.href="/system.php/Horder/to_all_order.html&num="+num;
    }
