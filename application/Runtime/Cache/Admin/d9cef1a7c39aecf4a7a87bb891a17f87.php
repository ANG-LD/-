...
<div class="ml170" id="page-content" style="overflow:auto;min-height:100%">
	<?php echo W('public/breadcrumbs',[ [ ['href'=>U('Index/index'),'text'=>'网站管理'], ['href'=>'','text'=>'系统信息'] ] ]);?>
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg mt-20">
        ...
        <tbody>
        <?php if(is_array($server_info)): $k = 0; $__LIST__ = $server_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
            <td><?php echo ($key); ?></td>
            <td><?php echo ($vo); ?></td>
